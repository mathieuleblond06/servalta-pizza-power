          ...
          <div className="w-full lg:w-1/2 animate-slide-left">
            <div className="relative">
              ...
              <div className="relative border-8 border-white shadow-2xl rounded-3xl overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-servalta-dark to-transparent p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-medium">Escanea para ver el menú</h4>
                      <p className="text-gray-300 text-sm">Actualización automática con tus últimas ofertas</p>
                    </div>
                  </div>
                </div>
              </div>
              
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-xl shadow-lg rotate-12 animate-float">
